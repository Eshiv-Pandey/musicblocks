...
* test(phrasemaker): add extensive unit test coverage for matrix and lifecycle by @karankumar1106 in https://github.com/sugarlabs/musicblocks/pull/8365
* docs: add bug reproduction section and UI/UX category guidance by @severe77 in https://github.com/sugarlabs/musicblocks/pull/8368
* fix(modewidget): keep _activeEDO at the old value while translating notes to a new EDO by @bhuvan-somisetty in https://github.com/sugarlabs/musicblocks/pull/8352
* test(ast): validate module plans against utility modules by @vanshika2720 in https://github.com/sugarlabs/musicblocks/pull/8292
* test(cypress): add cypress coverage for temperament widget by @Sumanthvu in https://github.com/sugarlabs/musicblocks/pull/8371
* test(cypress): add palette category navigation E2E test suite by @karankumar1106 in https://github.com/sugarlabs/musicblocks/pull/8309
* test(cypress): add E2E coverage for pitch staircase widget by @Sumanthvu in https://github.com/sugarlabs/musicblocks/pull/8378
* fix: refresh stale highlight cache when block re-enters viewport by @Abhishek-Sonje in https://github.com/sugarlabs/musicblocks/pull/8255
* fix(logo): keep persistent turtle listeners across stop/completion by @bhuvan-somisetty in https://github.com/sugarlabs/musicblocks/pull/8369
* fix(turtles): detach a removed turtle's stage children by @netram75 in https://github.com/sugarlabs/musicblocks/pull/8390
* fix(musicutils): return exactly edo names from generateNoteNames by @netram75 in https://github.com/sugarlabs/musicblocks/pull/8341
* refactor(status): replace platformColor.selectorBackground with CSS t& by @lavjeetrai in https://github.com/sugarlabs/musicblocks/pull/8394
* fix: clean up failed project imports by @patilpratik1905 in https://github.com/sugarlabs/musicblocks/pull/8356
* refactor(tuner): replace platformColor calls with CSS design tokens by @lavjeetrai in https://github.com/sugarlabs/musicblocks/pull/8395
* fix(toolbar): stop tooltip re-init from crashing Velocity by @gouravj25551-afk in https://github.com/sugarlabs/musicblocks/pull/8205
* fix(actions): prevent non-finite parameter propagation in ToneActions doVibrato by @uday-2304 in https://github.com/sugarlabs/musicblocks/pull/8382
* perf(status): throttle status widget rendering to animation frames by @NAME-ASHWANIYADAV in https://github.com/sugarlabs/musicblocks/pull/8307
* fix(piemenus): close pie menus with the Escape key by @NAME-ASHWANIYADAV in https://github.com/sugarlabs/musicblocks/pull/8396
* fix(legobricks): guard the tainted canvas pixel read, with widget test coverage by @netram75 in https://github.com/sugarlabs/musicblocks/pull/8388
* fix(toolbar): stop the click handler resetting tooltip options by @netram75 in https://github.com/sugarlabs/musicblocks/pull/8401
* test(cypress): add E2E coverage for Meter widget by @Sumanthvu in https://github.com/sugarlabs/musicblocks/pull/8398
* test(rhythmruler): add extensive unit test coverage for circular view and lifecycle by @karankumar1106 in https://github.com/sugarlabs/musicblocks/pull/8372
* fix: allow isInt to accept string representations of integers by @sreeram5555 in https://github.com/sugarlabs/musicblocks/pull/8410
* fix(blocks): stop viewport culling from killing the render loop by @rakshityadav1868 in https://github.com/sugarlabs/musicblocks/pull/8411
* fix(themes): restore widget body text contrast in dark and high contrast by @rakshityadav1868 in https://github.com/sugarlabs/musicblocks/pull/8412
* test(musickeyboard): add sequencer matrix grid, note tracking, and chord grouping coverage by @karankumar1106 in https://github.com/sugarlabs/musicblocks/pull/8405
* test(widgets): add unit test coverage for RhythmRuler calculations and lifecycle methods by @karankumar1106 in https://github.com/sugarlabs/musicblocks/pull/8358
* fix(abc): write accidentals before pitch names by @macayu17 in https://github.com/sugarlabs/musicblocks/pull/8417
* test(protoblocks): cover block shape definitions and their generators by @netram75 in https://github.com/sugarlabs/musicblocks/pull/8404
* fix(widgets): implement defensive initialization in MeterWidget by @uday-2304 in https://github.com/sugarlabs/musicblocks/pull/8386
* fix: palette overflow when auxiliary menu is open by @severe77 in https://github.com/sugarlabs/musicblocks/pull/8415
* fix(blocks): use iterative DFS for graph cycle detection in loadNewBlocks by @dhruvpatil972 in https://github.com/sugarlabs/musicblocks/pull/7789
* fix(piemenus): release the instrument pie menu when it closes by @rakshityadav1868 in https://github.com/sugarlabs/musicblocks/pull/8373
* fix: resolve reciprocal return, sign, and reduction in rationalToFraction by @Chaitu7032 in https://github.com/sugarlabs/musicblocks/pull/8397
* fix: export Rhythm Ruler block's collapsed state under its real block name by @rupeshkumar92a-arch in https://github.com/sugarlabs/musicblocks/pull/8429
* test(ast): add test generation infrastructure by @vanshika2720 in https://github.com/sugarlabs/musicblocks/pull/8379
* fix: resolve case mismatch in pitchToNumber includes check by @sreeram5555 in https://github.com/sugarlabs/musicblocks/pull/8409
* test: increase test coverage for pitchdrummatrix by @Jetshree in https://github.com/sugarlabs/musicblocks/pull/8430
* test(synth): cover recorder setup, download flow, and analyser lifecycle by @netram75 in https://github.com/sugarlabs/musicblocks/pull/8343
* test: ast generated test validation by @vanshika2720 in https://github.com/sugarlabs/musicblocks/pull/8381
* fix(musicutils): correct diminished 7 interval ratio from 9/5 to 128/75 by @rajanpanth in https://github.com/sugarlabs/musicblocks/pull/8436
* fix(musicutils): resolve C and F double flats a semitone below the single flat by @rajanpanth in https://github.com/sugarlabs/musicblocks/pull/8437
* fix(notation): route notationMarkup through the queue and run the meter reorder by @rajanpanth in https://github.com/sugarlabs/musicblocks/pull/8445
* fix(phrasemaker): remove every block map entry for a cleared cell by @netram75 in https://github.com/sugarlabs/musicblocks/pull/8443
* fix: bind _scale method context for Mode widget maximize by @gourijain029-del in https://github.com/sugarlabs/musicblocks/pull/8431
* feat(block-drag): defer spatial grid updates during block dragging by @Abhishek-Sonje in https://github.com/sugarlabs/musicblocks/pull/8449
* fix(phrasemaker): clear playback timers to prevent overlapping audio (#6976) by @dhruvpatil972 in https://github.com/sugarlabs/musicblocks/pull/8438
* docs: correct doubled words in documentation by @marekl11 in https://github.com/sugarlabs/musicblocks/pull/8467
* fix(blocks): serialize loadNewBlocks() calls to prevent state corruption by @bhuvan-somisetty in https://github.com/sugarlabs/musicblocks/pull/8393
* fix: cross platform path resolution and symlink handling in test generator by @Jetshree in https://github.com/sugarlabs/musicblocks/pull/8466
* fix(blocks): key the spatial grid on the block number, not the raw index by @netram75 in https://github.com/sugarlabs/musicblocks/pull/8476
* fix(blocks): index renameDos numerically so its block comparisons match by @netram75 in https://github.com/sugarlabs/musicblocks/pull/8478
* fix(jseditor): resolve config loading on file protocol and execution by @dhruvpatil972 in https://github.com/sugarlabs/musicblocks/pull/8439
* fix(musickeyboard): give padded keys a voice on a single-note keyboard by @rakshityadav1868 in https://github.com/sugarlabs/musicblocks/pull/8487
* fix: guard against null blocks in BlockScaleController (Fixes #6436) by @dhruvpatil972 in https://github.com/sugarlabs/musicblocks/pull/8488
* fix: generateNoteNames returns wrong length for edo < 7 by @khanshekhufarhan in https://github.com/sugarlabs/musicblocks/pull/8377
* test(e2e): add cypress coverage for trash panel and block restoration by @karankumar1106 in https://github.com/sugarlabs/musicblocks/pull/8334
* test(cypress): stabilize meter and pitch staircase widget E2E teardown and navigation by @karankumar1106 in https://github.com/sugarlabs/musicblocks/pull/8468
* fix(turtle-painter): stop the canvas colour being converted twice by @kunalKumar-13 in https://github.com/sugarlabs/musicblocks/pull/8493
* test: add test case for chord block connection hierarchy in _savePhrase by @kartikktripathi in https://github.com/sugarlabs/musicblocks/pull/8519
* fix(midi): compare numeric indices when linking imported blocks by @kunalKumar-13 in https://github.com/sugarlabs/musicblocks/pull/8506
* fix(musicutils): normalise the mode name when choosing sharps or flats by @kunalKumar-13 in https://github.com/sugarlabs/musicblocks/pull/8507
* test(ast): add generated coverage for utility modules by @vanshika2720 in https://github.com/sugarlabs/musicblocks/pull/8457
* fix(a11y): correct dark-mode popup message contrast to meet WCAG AA (#6608) by @abhnish in https://github.com/sugarlabs/musicblocks/pull/8544
* fix(themes): fix unreadable text in status matrix and pitch staircase cells by @rakshityadav1868 in https://github.com/sugarlabs/musicblocks/pull/8454
* fix: replace unreachable try/catch with isNaN check in toInteger() by @gourijain029-del in https://github.com/sugarlabs/musicblocks/pull/8514
* fix(keyboard): scroll the open palette with the arrow keys instead of throwing by @rakshityadav1868 in https://github.com/sugarlabs/musicblocks/pull/8521
* fix(highcontrast): consume design tokens for trash view styling by @karankumar1106 in https://github.com/sugarlabs/musicblocks/pull/8465
* perf(turtle-singer): remove discarded per-note ratio computation by @NAME-ASHWANIYADAV in https://github.com/sugarlabs/musicblocks/pull/8504
* fix(toolbar): stop the mode switch shifting the save menu handlers by @rakshityadav1868 in https://github.com/sugarlabs/musicblocks/pull/8522
* fix(sampler): use tuner cents offset by @macayu17 in https://github.com/sugarlabs/musicblocks/pull/8473
* fix(widgets): scope pitchstaircase maximization to widget body by @Diwaspant132 in https://github.com/sugarlabs/musicblocks/pull/8485
* fix(statistics): release the busy state so the widget cannot deadlock by @kunalKumar-13 in https://github.com/sugarlabs/musicblocks/pull/8495
* fix: temperament retuning when starting pitch changes by @Abhishek-Sonje in https://github.com/sugarlabs/musicblocks/pull/8525
* refactor: use the shared announceToScreenReader for aria-live announcements by @kunalKumar-13 in https://github.com/sugarlabs/musicblocks/pull/8527
* fix: parse the debug and performance query parameters instead of substring matching by @kunalKumar-13 in https://github.com/sugarlabs/musicblocks/pull/8528
* test: increase test coverage for synthutils.js by @Jetshree in https://github.com/sugarlabs/musicblocks/pull/8529
* fix(heap): restore the turtle heap as an array, not an object by @netram75 in https://github.com/sugarlabs/musicblocks/pull/8539
* fix(toolbar): don't waste the first step-by-step click on a fresh run by @gouravj25551-afk in https://github.com/sugarlabs/musicblocks/pull/8408
* fix(utils): take the mixed-number whole part from the magnitude by @netram75 in https://github.com/sugarlabs/musicblocks/pull/8542
* test(cypress): add E2E initialization and rendering coverage for Oscilloscope widget by @uday-2304 in https://github.com/sugarlabs/musicblocks/pull/8453
* fix(rhythmruler): reset circular view state when the widget relaunches by @rakshityadav1868 in https://github.com/sugarlabs/musicblocks/pull/8550
* chore: remove debug console statements from BooleanBlocks.js by @rupeshkumar92a-arch in https://github.com/sugarlabs/musicblocks/pull/8420
* fix(js-editor): add meter getter conversions by @severe77 in https://github.com/sugarlabs/musicblocks/pull/8551
* fix(mxml): use the closed-form dot multiplier for note duration by @bhuvan-somisetty in https://github.com/sugarlabs/musicblocks/pull/8533
* chore: remove debug console statements from turtle.js by @ShivamGupta2003 in https://github.com/sugarlabs/musicblocks/pull/8526
* refactor(styles): consolidate design tokens into tokens.css as single& by @dhruv-prajaparti in https://github.com/sugarlabs/musicblocks/pull/8489
* fix(volume): clamp relative volume to 0 so a decrease cannot raise it by @netram75 in https://github.com/sugarlabs/musicblocks/pull/8549
* feat(pitchslider): add Shift + Arrow key shortcuts for live octave navigation by @yush-1018 in https://github.com/sugarlabs/musicblocks/pull/8518
* feat(widgetWindows): wire global keydown listener for widget keyboard accessibility by @yush-1018 in https://github.com/sugarlabs/musicblocks/pull/8313
* fix: scope the value-bar hotkey guard instead of blocking all shortcuts (#6608) by @abhnish in https://github.com/sugarlabs/musicblocks/pull/8546
* test: add focused coverage for rubrics and focus-cycle-manager by @vanshika2720 in https://github.com/sugarlabs/musicblocks/pull/8565
* docs: repair broken links and image paths in the guides by @marekl11 in https://github.com/sugarlabs/musicblocks/pull/8554
* fix(activity): show the Stop button when a Start block is clicked by @kunalKumar-13 in https://github.com/sugarlabs/musicblocks/pull/8494
* fix(blocks): preserve loaded JSON data in named dictionaries by @karankumar1106 in https://github.com/sugarlabs/musicblocks/pull/8557
* fix(mathutils): doMinus and doMultiply throw NanError for non-numeric inputs by @uday-2304 in https://github.com/sugarlabs/musicblocks/pull/8553
* chore: remove debug console statements from phrasemaker.js by @ShivamGupta2003 in https://github.com/sugarlabs/musicblocks/pull/8569
* docs(guide-es): add alt text to Spanish guide buttons (Fixes #8568) by @yashspidey in https://github.com/sugarlabs/musicblocks/pull/8570
* fix(tempo): rename _firstClickTimes to _firstClickTime in init() by @uday-2304 in https://github.com/sugarlabs/musicblocks/pull/8575
...
* @sreeram5555 made their first contribution in https://github.com/sugarlabs/musicblocks/pull/8410
* @rupeshkumar92a-arch made their first contribution in https://github.com/sugarlabs/musicblocks/pull/8429
* @rajanpanth made their first contribution in https://github.com/sugarlabs/musicblocks/pull/8436
* @marekl11 made their first contribution in https://github.com/sugarlabs/musicblocks/pull/8467
* @khanshekhufarhan made their first contribution in https://github.com/sugarlabs/musicblocks/pull/8377
* @kunalKumar-13 made their first contribution in https://github.com/sugarlabs/musicblocks/pull/8493
* @Diwaspant132 made their first contribution in https://github.com/sugarlabs/musicblocks/pull/8485
* @ShivamGupta2003 made their first contribution in https://github.com/sugarlabs/musicblocks/pull/8526
* @dhruv-prajaparti made their first contribution in https://github.com/sugarlabs/musicblocks/pull/8489
* @yashspidey made their first contribution in https://github.com/sugarlabs/musicblocks/pull/8570
